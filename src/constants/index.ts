...
export const CEO_SKILLS = {
  skills: [
    { src: "/ceo/ceo-digital-growth.svg", label: "Digital Growth Strategy" },
    { src: "/ceo/ceo-dental-marketing.svg", label: "Dental Marketing" },
    { src: "/ceo/ceo-healthcare.svg", label: "Healthcare Digital Marketing" },
    { src: "/ceo/ceo-mental.svg", label: "Mental Health Clinic Growth" },
    { src: "/ceo/ceo-conversion-rate.svg", label: "Conversion Rate Optimization" },
    { src: "/ceo/ceo-crm.svg", label: "Custom CRM & CMS Development" },
    { src: "/ceo/ceo-AI-power-seo.svg", label: "AI-Powered SEO" },
    { src: "/ceo/ceo-saas-product.svg", label: "SaaS Product Development" },
    { src: "/ceo/ceo-design-psychology.svg", label: "Design Psychology" },
    { src: "/ceo/ceo-agency-white.svg", label: "Agency White Label Partner" },
    { src: "/ceo/ceo-full-stack.svg", label: "Full-Stack MERN Development" },
    { src: "/ceo/ceo-e-commerce.svg", label: "E-Commerce Growth" },
    { src: "/ceo/ceo-SEO.svg", label: "Search Engine Optimization" },
    { src: "/ceo/ceo-web-performance.svg", label: "Web Performance & Speed" },
  ],
};
