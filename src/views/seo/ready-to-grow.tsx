              ...
              <div className="flex h-full flex-col justify-between">
                <div>
                  ...
                  <p className="mt-4 text-white">
                    Paid advertising stops the moment spending pauses. SEO
                    continues working once a strong foundation is built and
                    maintained.
                    <br />
                    <br />
                    When your customers search, SEO helps you appear at the
                    right moment with the right message.
                  </p>
                </div>
            ...
            <div className="relative mt-10 overflow-hidden rounded-[10px] border border-white/25 bg-[linear-gradient(90deg,#075B65_0%,#00838A_50%,#328A99_100%)] px-5 py-10 md:px-10 md:py-12">
              ...
              <div className="relative mx-auto max-w-[760px] text-center">
                ...
                <p className="mx-auto mt-4 max-w-[660px] leading-[1.8] text-white">
                  Tell us what you offer, where you operate in Canada, and what
                  success looks like for your business. We will review your
                  current visibility and share a clear path forward based on
                  real findings.
                </p>
