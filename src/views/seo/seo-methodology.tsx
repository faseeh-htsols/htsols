                    ...
                    <div className="mx-auto max-w-6xl">
                        <div className="text-center">
                            ...
                            <p className="mt-5 text-white">
                                We follow a structured process so you always know where things stand.
                            </p>
                        </div>
                        ...
                        <div className="mt-8 border-t border-white">
                            {STEPS.map((step) => (
                                <div
                                    key={step.number}
                                    className="grid grid-cols-[42px_auto_1fr_auto] items-center gap-3 border-b border-white last:border-b-0 py-4 md:grid-cols-[56px_auto_1fr_auto] md:gap-5"
                                >
                                    {/* Number */}
                                    <h3 className="font-primary uppercase text-white/50  font-semibold mb-2">
                                        {step.number}
                                    </h3>

                                    {/* Title */}
                                    <h3 className="font-primary uppercase text-white  font-semibold">
                                        {step.title}
                                    </h3>
