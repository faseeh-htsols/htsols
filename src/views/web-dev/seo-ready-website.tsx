    ...
    <section className="relative overflow-hidden py-16 sm:py-20 lg:py-24">
      ...
      <Container>
        <div className="relative -mt-[200px ]">
          <div className="mx-auto max-w-5xl rounded-2xl border border-[#0B6F7A]/50 bg-black/55 backdrop-blur-md shadow-[0_20px_80px_rgba(0,0,0,0.7)] overflow-hidden px-6 py-10 sm:px-10 sm:py-12 lg:px-14 lg:py-14">
            ...
            <div className="relative mx-auto max-w-4xl text-center">
              ...
              <p className="mt-4  text-white ">
                Every HTSOL Inc. website is built with technical SEO foundations
                baked in from the start, not added as an afterthought. This
                matters because strong foundations make it easier for search
                engines to understand your site, and easier for customers to use
                it.
              </p>
              ...
              <p className="mt-7 ">
                This helps your site rank more consistently and makes your paid
                traffic convert better too.
              </p>
