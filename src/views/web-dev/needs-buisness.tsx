        ...
        <div className="flex flex-col gap-12">
          ...
          <div>
            <p className="text-center">
              ...
              businesses across Canada, including service providers,
              professional firms, local brands, manufacturers, and e-commerce.
              You get a site that matches your goals, fits your operations, and
              supports long-term marketing. You do not get a template that looks
              good on day one and becomes a problem later.
            </p>
          </div>
