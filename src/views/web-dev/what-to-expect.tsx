...
const WhatToExpect = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-black py-16 sm:py-20 lg:py-24">
      {/* subtle vignette like the design */}
        ...
        <div className="relative">
          ...
          <div className="text-center">
            ...
            <p className="mt-8 mb-9 text-white text-lg">
              ...
              consistent communication. You always know what is happening, what
              is next, and what we need from you.
            </p>
                ...
                >
                  ...
                  >
                    ...
                    <div
                      ...
                      className={`grid grid-cols-[52px_1fr_24px] gap-4 transition-all duration-300 ${
                        isOpen
