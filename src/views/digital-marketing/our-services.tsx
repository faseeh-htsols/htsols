                ...
                <div className="flex flex-col lg:flex-row items-start gap-5">
                    <div className="lg:w-[250px] shrink-0 lg:pr-5 lg:border-r border-white h-full">
                        <div className="text-white flex flex-col gap-8 pt-0 lg:sticky lg:top-24">
                            ...
                            <p>
                                <b>HTSOL Inc.</b> offers a comprehensive range of <b>digital marketing services</b> designed to improve visibility, strengthen brand presence, and support measurable growth.
                                <br />
                                Each service works together as part of a larger strategy. This integrated approach helps businesses build consistent online momentum.
                            </p>
                    ...
                    <div className="grow pt-0">
                        <Accordion type="single" className="space-y-4 mb-12" collapsible>
                            {DIGITAL_MARKETING_SERVICES_OFFERED_ACCORDION.map((item, index) => (
                                <AccordionItem
                                    key={item.title}
                                    value={String(index)}
                                    className="
                                                    ...
                                                    <ul className="list-disc pl-5 space-y-4 marker:text-[#00A1A5]">
                                                        {item.lists.map((listItem, index) => (
                                                            <li key={index}>
                                                                ...
                                                                <p className="text-[#00A1A5] font-primary" dangerouslySetInnerHTML={{ __html: listItem.para }} />
                                                            </li>
                                                        ))}
                                                    </ul>
                                                )}
