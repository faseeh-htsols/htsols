...
const WhoWeHelp = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="py-24 bg-[url(/how-we-help.png)] bg-cover relative   -mt-[9%] sm:-mt-[5%] md:-mt-[5%] lg:-mt-[3%] xl:-mt-[3%] [clip-path:polygon(0_1%,100%_0,100%_99%,0_100%)] md:[clip-path:polygon(0_2%,100%_0,100%_98%,0_100%)] lg:[clip-path:polygon(0_3%,100%_0,100%_97%,0_100%)]"
    >
      {/* Top accent line */}
      <div
      ...
      <Container>
        <div className="flex flex-col gap-6">
          <HeadingTwo className="text-center" ref={headingRef}>
            Who We Help
          </HeadingTwo>
          <p
