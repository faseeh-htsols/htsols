...
type WhiteLabelFormValues = Yup.InferType<typeof validationSchema>;
...
const WhiteLabelHero = () => {
  ...
  const sendEmail = async (
    values: WhiteLabelFormValues,
    formikHelpers: FormikHelpers<WhiteLabelFormValues>,
  ) => {
    setIsSending(true);
      ...
      <Wrapper>
        <div className="relative grid items-center gap-8 sm:gap-10 xl:grid-cols-[minmax(0,780px)_630px] xl:justify-between xl:gap-12">
          <div className="max-w-[780px]">
            ...
            <div className="mb-8 inline-flex h-[48px] w-full max-w-[446px] items-center gap-[10px] rounded-full border border-[#00A1A5] px-[12px] py-[10px] sm:h-[53px] sm:px-[14px] [&>span:first-child]:hidden">
              <span className="mr-3 text-[#00A1A5]">•</span>
              <span className="h-2.5 w-2.5 shrink-0 rounded-full bg-[#00A1A5]" />
              <span className="inline-flex h-[33px] min-w-0 flex-1 items-center whitespace-nowrap font-sans text-[13px] font-light uppercase leading-none tracking-[0.02em] text-white sm:text-[16px] lg:text-[18px]">
                White Label Digital Agency Partner
              </span>
            </div>

            <h1 className="max-w-[780px] font-primary text-[34px] font-semibold uppercase leading-[0.92] tracking-[-0.04em] text-white sm:text-5xl sm:tracking-[-0.045em] lg:text-[56px] xl:text-[64px]">
            ...
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-white/82 sm:mt-8 sm:text-xl">
              ...
              under your brand - and your clients never know we exist.
            </p>
              ...
              <div className="overflow-hidden rounded-[30px] bg-[linear-gradient(180deg,rgba(38,38,38,0.8)_0%,rgba(20,20,20,0.84)_100%)] shadow-[0_30px_90px_rgba(0,0,0,0.45)] backdrop-blur-xl">
                <div className="bg-[linear-gradient(180deg,rgba(10,98,103,0.48)_0%,rgba(8,62,66,0.28)_100%)] px-6 py-5 text-center">
                  <h2 className="mx-auto flex min-h-16 w-full max-w-[420px] flex-col items-center justify-center font-primary text-[19px] font-semibold uppercase leading-[1] tracking-[-0.03em] text-white sm:text-[24px] lg:text-[30px]">
                    ...
                    <span className="block whitespace-nowrap">Confidence</span>
                  </h2>
                </div>

                <div className="p-4 sm:p-6 lg:px-7 lg:pb-7 lg:pt-6">
                  <Formik<WhiteLabelFormValues>
                    initialValues={{
                      firstName: "",
                      lastName: "",
                      email: "",
