          ...
          <div className="flex flex-row flex-wrap justify-center gap-10 mt-8 md:mt-12">
            {data.services.map((item, index) => (
              ...
              >
                ...
                <div className="flex flex-col gap-4">
                  <div className="p-4 border border-[#075B65] group-hover:bg-white w-fit rounded-full group-hover:[&_svg_path]:fill-black! relative">
                    <Image
                      width={27}
                      height={34}
                      src={item.icon}
                    ...
                    <Image
                      ...
                      src={item.hoverIcon}
                      alt={item.heading}
                      className="w-8 h-8 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 transition-opacity group-hover:opacity-100"
                    />
                  </div>

                  <h3 className="font-primary font-semibold text-[18px] uppercase">
                    {item.heading}
                  </h3>
            ...
            <div className="relative flex items-center justify-center lg:w-[calc(33.33%-27px)] rounded-lg bg-transparent px-4 py-9 text-center">
              <div className="flex flex-col items-center gap-5 w-full lg:max-w-[300px]">
                ...
                <p
                  dangerouslySetInnerHTML={{ __html: data.endServices.para }}
                ></p>
