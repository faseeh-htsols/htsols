              ...
              <Form ref={formRef}>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 mb-5">
                  <div>
                    <Field
                      type="text"
                      name="fullName"
                      className="h-10 w-full relative outline-0 bg-white border border-black rounded-md px-4 backdrop:backdrop-blur-2xl placeholder:text-black text-black"
                  ...
                  <div>
                    <Field
                      type="text"
                      name="contactNumber"
                      className="h-10 w-full relative outline-0 bg-white border-black border rounded-md px-4 backdrop:backdrop-blur-2xl placeholder:text-black text-black"
                ...
                <div className="mb-3">
                  <Field
                    as="textarea"
                    name="message"
                    className="h-28 w-full relative outline-0 bg-white border border-black rounded-md px-4 py-3 backdrop:backdrop-blur-2xl placeholder:text-black text-black"
                    placeholder="Notes"
                    id=""
                  ></Field>
                  <ErrorMessage
                ...
                <div className="flex mt-6 justify-center">
                  <button
                    ...
                    className="inline-flex cursor-pointer text-white items-center bg-[linear-gradient(90deg,#075B65_0%,#00838A_37.02%,#328A99_81.25%)] gap-2 px-6 py-3 text-sm font-medium uppercase rounded-full tracking-wider transition-all duration-300 border"
                  >
