...
export const FAQSection: React.FC<FAQSectionProps> = ({
  ...
  return (
    <div className="overflow-visible!">
      <DoubleCurves
        up
        className="-mt-[9%] sm:-mt-[5%] md:-mt-[5%] lg:-mt-[4%] xl:-mt-[3%] [clip-path:polygon(0_0,100%_0,100%_100%,0_100%)] md:[clip-path:polygon(0_0,100%_0,100%_100%,0_100%)] lg:[clip-path:polygon(0_0,100%_0,100%_100%,0_100%)]">
        <section
          className=" py-24  "
          style={{
